...
function addRow(){
    $('#powerTable').append('<tr><td><input type="text" class="form-control input-sm"/></td><td><input type="text" class="form-control input-sm"/></td><td><a href="#cross" class="cross" onclick="removeRow()"><span class="glyphicon glyphicon-remove"></span></a></td></tr>');
}
