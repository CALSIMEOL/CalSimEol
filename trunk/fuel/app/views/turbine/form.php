...
$(function () {
        ...
        $('#turbManufacturer').focusout(function() {
        ...
        $('#nominalPower').focusout(function() {
        ...
        $('#cut-outSpeed').focusout(function() {
